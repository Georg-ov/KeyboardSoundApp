    ...
    public partial class MainForm : Form
    {
        ...
        private void PlaySound(Keys key)
        {
            if (isActive)
            {
                try
                {
                    using (SoundPlayer player = new SoundPlayer("C:\\Users\\Yoki\\source\\repos\\KeyboardSoundApp\\KeyboardSoundApp\\resources\\sounds\\tecla_1.wav")) // Ruta relativa o absoluta
                    {
